...
// hold, and rub out again on their own timers. Kept faint, doubled and
// roughened so they read as hand-drawn, and placed at the margins so the text
// column never has one behind it.
...
const SKETCHES: Sketch[] = [
  ...
  { d: 'M 150 190 a 62 62 0 1 1 -1 -6', duration: 14, delay: 0 },
  { d: 'M 154 186 a 60 64 0 1 0 2 -4', duration: 14, delay: 0.6 },
  // square, bottom right
  { d: 'M 1180 640 h 130 v 128 h -132 z', duration: 16, delay: 3 },
  { d: 'M 1184 644 h 124 v 122 h -126 z', duration: 16, delay: 3.4 },
  // cube, right edge
  {
  ...
  { d: 'M 60 820 Q 720 700 1400 830', duration: 20, delay: 5 },
  // dimension line with end ticks, top right
  { d: 'M 980 120 h 280 M 980 110 v 20 M 1260 110 v 20', duration: 12, delay: 9 },
