...
#: qualified subject like "Political Science, General", and rewriting that into
#: "General Political Science" would be worse than letting it split.
...
def reformat_name_heading(tag: str) -> str:
    """``Angelou, Maya, 1928-2014`` becomes ``Maya Angelou``. Others unchanged."""
    text = tag.strip()
